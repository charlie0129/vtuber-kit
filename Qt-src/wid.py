...
class Ui_VtbKit(object):
    def setupUi(self, VtbKit):
        ...
        self.label_voiceKind.setGeometry(QtCore.QRect(100, 110, 91, 31))
        font = QtGui.QFont()
        font.setFamily("文鼎大签字笔体G30")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.comboBox_vc.setGeometry(QtCore.QRect(190, 110, 121, 31))
        ...
        self.checkBox_enableVC.setGeometry(QtCore.QRect(120, 50, 281, 31))
        font = QtGui.QFont()
        font.setFamily("文鼎大签字笔体G30")
